    ...
    <div
      ...
      className={`flex justify-center  cursor-pointer ${
        selectTab === index
          ...
          : ""
      } box-border hover:text-primary_blue hover:border-[1px] hover:border-primary_blue flex items-center text-[14px] text-gray_400 bg-neutralwhite border-[1px] border-gray_200 rounded-[40px] h-[32px] pl-[16px] pr-[16px] pt-[10px] pb-[10px]`}
    >
      {selectTab === index && (
